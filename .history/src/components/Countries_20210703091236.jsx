    ...
    return (
        ...
        <div className="countries">
            <div className="sort-container">
                ...
                <ul>
                    { radios.map((radio) => <li key={radio}><input type="radio" name="radio" value={radio} id={radio} checked={radio===selectedRadio} onChange={(e) => {selectedRadio(e.target.value)}}/><label htmlFor={radio}>{radio}</label></li>)}
                </ul>
            </div>
